...
define('APPDIR', realpath(__DIR__ . '/../app/') . DS); // app
define('SYSTEMDIR', realpath(__DIR__ . '/../system/') . DS); // system
define('PUBLICDIR', realpath(__DIR__) . DS); // webroot
define('ROOTDIR', realpath(__DIR__ . '/../') . DS); // bp
